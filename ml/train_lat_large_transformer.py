...
testbatchnum = 0 #where to begin the test data
if 5000 % batchnum != 0:
...
x_test_g = x_test_g.view(-1,inst_length,context_length) #this is what linda does. but is it right?
x_test_g = x_test_g.permute([2,0,1])
...
print("Parms:",sum(p.numel() for p in simnet.parameters()))
...
for i in range(epoch_num):
    ...
    for didx in range(batchnum):
        ...
        x= x.view(-1,inst_length,context_length) #this is what linda does. but is it right?
        x = x.permute([2,0,1])
