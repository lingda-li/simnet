...
def main_rank(rank, args):
    ...
    dataset1 = CompressedDataset(data_file_name, total_size + 1, total_inst_num, 0, args.train_size, num_classes=num_classes)
    dataset2 = CompressedDataset(data_file_name, total_size + 1, total_inst_num, valid_start, valid_end, num_classes=num_classes)
