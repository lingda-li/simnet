                    ...
                    TRTUniquePtr<nvinfer1::IExecutionContext>& context)
{
    ...
    builder->setMaxBatchSize(65536);
    // generate TensorRT engine optimized for the target platform
    printf("Before engine and context\n");
    nvinfer1::IOptimizationProfile *profile= builder->createOptimizationProfile();
    profile->setDimensions("input", nvinfer1::OptProfileSelector::kMIN,  nvinfer1::Dims2(2048,5661));
    profile->setDimensions("input", nvinfer1::OptProfileSelector::kOPT,  nvinfer1::Dims2(65536,5661));
    profile->setDimensions("input", nvinfer1::OptProfileSelector::kMAX,  nvinfer1::Dims2(65536,5661));
    config->addOptimizationProfile(profile);
    context->setOptimizationProfile(0);
    //builder->setMaxBatchSize(65536);
    //context.setBindingDimensions(0, Dims2(65536, 5661));
...
int main(int argc, char* argv[])
{
   ...
   printf("%d\n",buffers.end() - buffers.begin()); 
	...
	printf("I: %d, Binding_size: %d,batch: %.2f ",i,binding_size,binding_size/5661);
